...
namespace SKONanobotBuildAndRepairSystem
{
    ...
    public static class NanobotTerminal
    {
        ...
        /// <returns></returns>
        private static NanobotSystem GetSystem(IMyTerminalBlock block)
        {
        ...
        public static void InitializeControls()
        {
            lock (CustomControls)
            {
                ...
                try
                {
                    ...
                    if (Logging.Instance.ShouldLog(Logging.Level.Event)) Logging.Instance.Write(Logging.Level.Event, "InitializeControls");
                    ...
                    CustomControls.Add(label);
                    {
                        // --- Set Color that marks blocks as 'ignore'
                        {
                            ...
                            checkbox.Enabled = Mod.Settings.Welder.UseIgnoreColorFixed || !weldingAllowed ? isReadonly : isBaRSystem;
                            ...
                            CreateProperty(checkbox, Mod.Settings.Welder.UseIgnoreColorFixed);
                        ...
                        CustomControls.Add(_SeparateWeldOptions);
                        {
                            ...
                            checkbox.OnText = MySpaceTexts.SwitchText_On;
                            checkbox.OffText = MySpaceTexts.SwitchText_Off;
                            checkbox.Enabled = Mod.Settings.Welder.AllowBuildFixed || !weldingAllowed ? isReadonly : isBaRSystem;
                            checkbox.Visible = isWeldingAllowed;
                            checkbox.Getter = (block) =>
                            {
                                var system = GetSystem(block);
                            ...
                            CustomControls.Add(checkbox);
                            CreateProperty(checkbox, Mod.Settings.Welder.AllowBuildFixed || !weldingAllowed);
                    ...
                    CustomControls.Add(label);
                    {
                        ...
                        //CustomControls.Add(separateArea);
                        {
                            ...
                            checkbox.OnText = MySpaceTexts.SwitchText_On;
                            checkbox.OffText = MySpaceTexts.SwitchText_Off;
                            checkbox.Enabled = Mod.Settings.Welder.UseGrindColorFixed || !grindingAllowed ? isReadonly : isBaRSystem;
                            ...
                            CustomControls.Add(checkbox);
                            CreateProperty(checkbox, Mod.Settings.Welder.UseGrindColorFixed || !grindingAllowed);
                        ...
                        CustomControls.Add(separateArea);
                        {
                            ...
                            onoffSwitch.Enabled = Mod.Settings.Welder.UseGrindJanitorFixed || !janitorAllowedEnemies ? isReadonly : isBaRSystem;
                            ...
                            onoffSwitch.OnText = MySpaceTexts.SwitchText_On;
                            onoffSwitch.OffText = MySpaceTexts.SwitchText_Off;
                            onoffSwitch.Enabled = Mod.Settings.Welder.UseGrindJanitorFixed || !janitorAllowedNoOwnership ? isReadonly : isBaRSystem;
                            ...
                            onoffSwitch.OnText = MySpaceTexts.SwitchText_On;
                            onoffSwitch.OffText = MySpaceTexts.SwitchText_Off;
                            onoffSwitch.Enabled = Mod.Settings.Welder.UseGrindJanitorFixed || !janitorAllowedNeutral ? isReadonly : isBaRSystem;
                        ...
                        CustomControls.Add(separateArea);
                        {
                            ...
                            checkbox.OnText = MySpaceTexts.SwitchText_On;
                            checkbox.OffText = MySpaceTexts.SwitchText_Off;
                            checkbox.Enabled = Mod.Settings.Welder.UseGrindJanitorFixed || !grindingAllowed ? isReadonly : isBaRSystem;
                            ...
                            CustomControls.Add(checkbox);
                            CreateProperty(checkbox, Mod.Settings.Welder.UseGrindJanitorFixed || !grindingAllowed);
                    ...
                    CustomControls.Add(label);
                    {
                        ...
                        //CustomControls.Add(separateArea);
                        {
                            ...
                            checkbox.OnText = MySpaceTexts.SwitchText_On;
                            checkbox.OffText = MySpaceTexts.SwitchText_Off;
                            checkbox.Enabled = Mod.Settings.Welder.CollectIfIdleFixed ? isReadonly : isCollectPossible;
                            checkbox.Getter = (block) =>
                            {
                                var system = GetSystem(block);
                            ...
                            CustomControls.Add(checkbox);
                            CreateProperty(checkbox, Mod.Settings.Welder.CollectIfIdleFixed);
                            ...
                            checkbox.OnText = MySpaceTexts.SwitchText_On;
                            checkbox.OffText = MySpaceTexts.SwitchText_Off;
                            checkbox.Enabled = Mod.Settings.Welder.PushIngotOreImmediatelyFixed ? isReadonly : isBaRSystem;
                            checkbox.Getter = (block) =>
                            {
                                var system = GetSystem(block);
                            ...
                            CustomControls.Add(checkbox);
                            CreateProperty(checkbox, Mod.Settings.Welder.PushIngotOreImmediatelyFixed);
                            ...
                            checkbox.OnText = MySpaceTexts.SwitchText_On;
                            checkbox.OffText = MySpaceTexts.SwitchText_Off;
                            checkbox.Enabled = Mod.Settings.Welder.PushItemsImmediatelyFixed ? isReadonly : isBaRSystem;
                            checkbox.Getter = (block) =>
                            {
                                var system = GetSystem(block);
                            ...
                            CustomControls.Add(checkbox);
                            CreateProperty(checkbox, Mod.Settings.Welder.PushItemsImmediatelyFixed);
                            ...
                            checkbox.OnText = MySpaceTexts.SwitchText_On;
                            checkbox.OffText = MySpaceTexts.SwitchText_Off;
                            checkbox.Enabled = Mod.Settings.Welder.PushComponentImmediatelyFixed ? isReadonly : isBaRSystem;
                            checkbox.Getter = (block) =>
                            {
                                var system = GetSystem(block);
                            ...
                            CustomControls.Add(checkbox);
                            CreateProperty(checkbox, Mod.Settings.Welder.PushComponentImmediatelyFixed);
                        }
                    }
                    ...
                    CustomControls.Add(separateArea);
                    {
                        ...
                        checkbox.OnText = MySpaceTexts.SwitchText_On;
                        checkbox.OffText = MySpaceTexts.SwitchText_Off;
                        checkbox.Enabled = Mod.Settings.Welder.ShowAreaFixed ? isReadonly : isBaRSystem;
                        checkbox.Getter = (block) =>
                        {
                            var system = GetSystem(block);
                            if (system != null)
                        ...
                        CustomControls.Add(checkbox);
                        CreateProperty(checkbox, Mod.Settings.Welder.ShowAreaFixed);
                        ...
                        slider.Enabled = Mod.Settings.Welder.AreaOffsetFixed ? isReadonly : isBaRSystem;
                        slider.Getter = (block) =>
                        {
                            var system = GetSystem(block);
                        ...
                        slider.Enabled = Mod.Settings.Welder.AreaSizeFixed ? isReadonly : isBaRSystem;
                        slider.Getter = (block) =>
                        {
                            var system = GetSystem(block);
                        ...
                        slider.Enabled = Mod.Settings.Welder.SoundVolumeFixed ? isReadonly : isBaRSystem;
                        slider.Getter = (block) =>
                        {
                            var system = GetSystem(block);
