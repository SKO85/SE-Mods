    ...
    public static class Utils
    {
        ...
        public static VRage.Game.MyRelationsBetweenPlayerAndBlock GetUserRelationToOwner(this IMySlimBlock slimBlock, long userId)
        {
            ...
            if (fatBlock != null)
            {
                ...
                // the cached grid relation. Saves the per-block engine call on the dominant
                // case (most fat blocks inherit grid ownership rather than being individually
                // claimed) — the scan loop walks ~7 000 blocks per huge grid so this matters.
