...
namespace SKONanobotBuildAndRepairSystem.Localization
{
    public static class TextsPolish
    {
        public static Dictionary<string, string> Dictionary = new Dictionary<string, string>()
        {
            ...
            {"WeldBuildNew",                    "Buduj projekcje"},
            {"WeldBuildNew_Tooltip",            "Po włączeniu system będzie również budował bloki z projektora."},
            ...
            {"Priority_EnableAll",              "Włącz wszystkie"},
            {"Priority_DisableAll",             "Wyłącz wszystkie"},
            ...
            {"DisableParticleEffects",          "Wyłącz efekty latających nanobotów"},
            {"DisableParticleEffects_Tooltip",  "Po zaznaczeniu efekty śladowe latających nanobotów (pobieranie i dostarczanie) dla tego bloku są wyłączone. Iskry spawania i szlifowania nie są zmieniane."},
            {"ResetAllSettings",                "Resetuj wszystkie ustawienia"},
            {"ResetAllSettings_Tooltip",        "Resetuje wszystkie ustawienia tego bloku do wartości domyślnych, w tym stany list priorytetów."},
            ...
            {"Info_CurrentWeldEntity",           "Wybrany blok do spawania:"},
            {"Info_CurrentGrindEntity",          "Wybrany blok do rozbiórki:"},
