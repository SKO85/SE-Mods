...
namespace SKONanobotBuildAndRepairSystem.Localization
{
    public static class TextsGerman
    {
        public static Dictionary<string, string> Dictionary = new Dictionary<string, string>()
        {
            ...
            {"WeldBuildNew",                    "Projektionen bauen"},
            {"WeldBuildNew_Tooltip",            "Wenn aktiviert, wird das System auch projizierte Blöcke eines Projektors erzeugen und schweißen."},
            ...
            {"GrindPriority_Tooltip",           "Schaltet das Demontieren des selektierten Blocktyps ein/aus und legt die Priorität fest.\n(Deaktivierte Typen werden nie demontiert, auch nicht wenn sie mit der Demontagefarbe markiert sind)"},
