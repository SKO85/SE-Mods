...
namespace SKONanobotBuildAndRepairSystem.Localization
{
    public static class TextsEnglish
    {
        public static Dictionary<string, string> Dictionary = new Dictionary<string, string>()
        {
            ...
            {"WeldBuildNew",                    "Build Projections"},
            {"WeldBuildNew_Tooltip",            "When enabled, the system will also construct projected blocks from a projector."},
            {"WeldMode",                        "Weld mode"},
            {"WeldMode_Tooltip",                "Select how far the nanobots weld blocks."},
            {"WeldMode_Full",                   "Weld to full"},
            {"WeldMode_Functional",             "Weld to functional"},
            ...
            {"Priority_EnableAll",              "Enable All"},
            {"Priority_DisableAll",             "Disable All"},
            ...
            {"DisableParticleEffects",          "Disable flying nanobot effects"},
            {"DisableParticleEffects_Tooltip",  "When enabled, the flying nanobot trace effects (pick and deliver) for this block are disabled. Welding and grinding sparks are unaffected."},
            {"ResetAllSettings",                "Reset All Settings"},
            {"ResetAllSettings_Tooltip",        "Resets all settings for this block to their default values, including priority list states."},
            ...
            {"Info_CurrentWeldEntity",           "Picked Welding Block:"},
            {"Info_CurrentGrindEntity",          "Picked Grinding Block:"},
