...
namespace SKONanobotBuildAndRepairSystem.Localization
{
    public static class TextsRussian
    {
        public static Dictionary<string, string> Dictionary = new Dictionary<string, string>()
        {
            ...
            {"WeldBuildNew",                    "Строить проекции"},
            {"WeldBuildNew_Tooltip",            "Если включено, система также будет строить\nпроецируемые блоки из проектора."},
            ...
            {"GrindPriority_Tooltip",           "Включить/выключить распиливание выбранных видов\nблоков и установить приоритет во время распиливания (Отключённые виды никогда не распиливаются, даже если помечены цветом распиливания)."},
            ...
            {"Priority_EnableAll",              "Включить все"},
            {"Priority_DisableAll",             "Отключить все"},
            ...
            {"DisableParticleEffects",          "Отключить летящие эффекты наноботов"},
            {"DisableParticleEffects_Tooltip",  "Если включено, летящие следы наноботов (подбор и доставка) для этого блока отключаются. Искры сварки и шлифовки не затрагиваются."},
            {"ResetAllSettings",                "Сбросить все настройки"},
            {"ResetAllSettings_Tooltip",        "Сбрасывает все настройки этого блока до значений по умолчанию, включая состояния списков приоритетов."},
            ...
            {"Info_CurrentWeldEntity",           "Выбран блок сварщика:"},
            {"Info_CurrentGrindEntity",          "Выбран блок резака:"},
