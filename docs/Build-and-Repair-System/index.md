...
- **Work Modes** — choose between Weld Before Grind, Grind Before Weld, Grind If Stuck, Weld Only, or Grind Only
...
*Applies to the (Maintained) - Nerfed Version. The Original Resources Version uses the original mod values.*
...
*Applies to the (Maintained) - Nerfed Version only. See the [Original Resources Version](https://steamcommunity.com/sharedfiles/filedetails/?id=3099489876) for the original build components.*
